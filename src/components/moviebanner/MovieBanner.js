...
function MovieBanner({ originalLanguage, mediaType, updateScreen, changeScreen, changeSelectedComponent, kidMode }) {
    ...
    const updateAPI = (tries) => {
        ...
        if (kidMode === true) {
            Axios.get(`https://api.themoviedb.org/3/${mediaType}/popular?api_key=${'1d8b18c7e7e46b9960d2a56191f9c537'}&with_original_language=${originalLanguage}&with_genres=16&include_adult=false&page=1`)
                .then((response) => {'1d8b18c7e7e46b9960d2a56191f9c537'
            ...
            Axios.get(`https://api.themoviedb.org/3/${mediaType}/popular?api_key=${'1d8b18c7e7e46b9960d2a56191f9c537'}&with_original_language=${originalLanguage}&include_adult=false&page=1`)
                .then((response) => {
